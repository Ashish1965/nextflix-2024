...
export default function ManageAccounts() {
  const { accounts, setAccounts, pageLoader, setPageLoader , loggedInAccount , setLoggedInAccount } =
  ...
  return (
    <div className="min-h-screen flex justify-center flex-col items-center relative">
      <div className="flex justify-center flex-col items-center">
        ...
        <ul className="flex md:gap-1 lg:gap-8 my-[25px] md:flex-row flex-col gap-9">
        ...
        <div className="text-center p-5">
          <span
            ...
            className="border border-gray-100 cursor-pointer tracking-wide inline-flex text-sm px-[1.5rem] py-[0.5rem]"
          >
            Manage Profiles
          </span>
        </div>
